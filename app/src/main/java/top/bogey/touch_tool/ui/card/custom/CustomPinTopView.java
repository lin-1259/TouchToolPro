...
import top.bogey.touch_tool.databinding.PinCustomTopBinding;
import top.bogey.touch_tool.ui.card.pin.PinBaseView;
import top.bogey.touch_tool.utils.DisplayUtils;
import top.bogey.touch_tool.utils.TextChangedListener;

@SuppressLint("ViewConstructor")
public class CustomPinTopView extends PinBaseView<PinCustomTopBinding> {
    public CustomPinTopView(@NonNull Context context, CustomCard card, Pin pin) {
        super(context, PinCustomTopBinding.class, card, pin);
